...
# 47 "/usr/include/x86_64-linux-gnu/sys/select.h" 3 4
# 1 "/usr/include/x86_64-linux-gnu/bits/time.h" 1 3 4
...
struct list* assign_list( struct list **const assignTo,
 ...
 if ( assignIt == assignTo
  || *assignIt == *assignTo
  || assignIt == 
# 50 "source/list.c" 3 4
                ((void *)0)
  
# 51 "source/list.c"
 || assignTo == 
# 51 "source/list.c" 3 4
                ((void *)0)
# 51 "source/list.c"
                    ) {
  ...
  return 
# 57 "source/list.c" 3 4
        ((void *)0)
# 57 "source/list.c"
            ;
 }
 else if ( *assignIt == 
# 59 "source/list.c" 3 4
                       ((void *)0)
# 59 "source/list.c"
                           ) {
...
# 156 "source/list.c"
 ...
 copyItCurrent = 
# 163 "source/list.c" 3 4
                ((void *)0)
# 163 "source/list.c"
                    ;
 newCurrent = 
# 164 "source/list.c" 3 4
             ((void *)0)
# 164 "source/list.c"
                 ;
...
# 175 "source/list.c"
 ...
 newList->head = 
# 178 "source/list.c" 3 4
                ((void *)0)
# 178 "source/list.c"
                    ;
 newList->length = 0LL;
 pthread_rwlock_init( &( newList->mutex), 
# 180 "source/list.c" 3 4
                                         ((void *)0)
# 180 "source/list.c"
                                             );
 return newList;
...
# 245 "source/list.c"
 ...
 if ( index < 0LL || ( *this)->length == 0x7fffffffffffffffL
  || index > ( *this)->length) {
  pthread_rwlock_unlock(
   &( ( *this)->mutex));
  return '\x00';
...
# 289 "source/list.c"
  ...
  for ( count = 1LL, current = 
# 292 "source/list.c" 3 4
                              ((void *)0)
# 292 "source/list.c"
                                  ,
   previous = ( *this)->head;
   previous != 
# 294 "source/list.c" 3 4
              ((void *)0) 
# 294 "source/list.c"
                   && count < index;
...
# 301 "source/list.c" 3 4
                                    ((void *)0)
# 301 "source/list.c"
                                        ) {
   previous = 
# 302 "source/list.c" 3 4
             ((void *)0)
# 302 "source/list.c"
                 ;
   pthread_rwlock_unlock(
...
# 452 "source/list.c" 3 4
                                   ((void *)0)
# 452 "source/list.c"
                                       ) {
   current = 
# 453 "source/list.c" 3 4
            ((void *)0)
# 453 "source/list.c"
                ;
   pthread_rwlock_unlock(
...
# 468 "source/list.c"
   ...
   current->next = after;
   after = 
# 471 "source/list.c" 3 4
          ((void *)0)
# 471 "source/list.c"
              ;
   current = 
# 472 "source/list.c" 3 4
            ((void *)0)
# 472 "source/list.c"
                ;
   --( *this)->length;
...
# 494 "source/list.c"
  ...
  *end1, *before;
 start0 = start1 = end0 = end1 = before = 
# 506 "source/list.c" 3 4
                                         ((void *)0)
# 506 "source/list.c"
                                             ;
